...
pickle_filename = DATALOADER_TYPE + '_' + str(NO) + '_' + PART_SIZE + '_' + str(DL_SHUFFLE) + '_' + str(DL_PARTS_PER_CHUNK)
...
if DATALOADER_TYPE=='NVT':
    ...
    train_dataset = TorchAsyncItr(nvt.Dataset(TRAIN_PATHS, part_size=PART_SIZE), 
                                  batch_size=BATCH_SIZE, 
                                  cats=CATEGORICAL_COLUMNS, conts=CONTINUOUS_COLUMNS, labels=LABEL_COLUMNS,
                                  shuffle=DL_SHUFFLE,
    ...
    valid_dataset = TorchAsyncItr(nvt.Dataset(VALID_PATHS, part_size=PART_SIZE), 
                                  batch_size=BATCH_SIZE, 
                                  cats=CATEGORICAL_COLUMNS, conts=CONTINUOUS_COLUMNS, labels=LABEL_COLUMNS)
