...
proc.apply(train_ds_iterator, apply_offline=True, record_stats=True, output_path=PREPROCESS_DIR_TRAIN, shuffle=True, num_out_files=1)
...
gdf= cudf.read_parquet('/home/ronayak/ronaya/recsys/nvtabular/examples/data/jp_ross/train/0.parquet')
print(gdf.shape)
print(gdf.columns)