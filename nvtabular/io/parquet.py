    ...
    def __init__(
        ...
        if row_groups_per_part is None:
            ...
            if row_groups_per_part < 1.0:
                warnings.warn(
                    f"Row group memory size ({rg_byte_size_0}) (bytes) of parquet file is bigger than requested part_size ({self.part_size}) for the NVTabular dataset. A row group memory size of 128 MB is generally recommended. You can find info on how to set the row group size of parquet files in https://nvidia.github.io/NVTabular/main/HowItWorks.html#getting-your-data-ready-for-nvtabular"
                )
