...
BASE_SERIALIZATION_CLASSES = {
    ...
    "merlin.dag.graph": ["Graph"],
    "merlin.dag.node": ["Node"],
    "merlin.dag.ops.selection": ["SelectionOp"],
    "merlin.dag.ops.subgraph": ["Subgraph"],
    "merlin.dag.selector": ["ColumnSelector"],
    "merlin.schema.schema": ["Schema", "ColumnSchema"],
    "merlin.schema.tags": ["Tag", "Tags","TagSet"],
    "merlin.dtypes.base": ["DType", "ElementType"],
    "merlin.dtypes.shape": ["Shape", "Dimension"],
    "merlin.dag.ops.udf": ["UDF"],
    "nvtabular.ops.fill": ["FillMissing"],
    "nvtabular.ops.categorify": ["Categorify"],
    "nvtabular.ops.clip": ["Clip"],
    "nvtabular.ops.logop": ["LogOp"],
    "nvtabular.ops.normalize": ["Normalize"],
    "nvtabular.ops.target_encoding": ["TargetEncoding"],
    "nvtabular.ops.rename": ["Rename"],
