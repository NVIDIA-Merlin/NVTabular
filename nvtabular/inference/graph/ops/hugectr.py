...
class HugeCTROp(InferenceOperator):
    def __init__(self, model_path, params=None, name=None, max_batch_size=None):
    ...
    def export(self, path, consumer_config, version=1):
        ...
        return generate_hugectr_model(self.model_path, self.params, self.export_name, new_dir_path, version=version, max_batch_size=self.max_batch_size)
