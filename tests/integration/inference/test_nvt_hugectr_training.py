...
def test_nvt_hugectr_training():
    ...
    hugectr_params = dict()
    hugectr_params["config"] = MODEL_DIR + "movielens/1/model.json"
    ...
    config = json.dumps(
        {
            "inference": {
                ...
                "dense_model_file": MODEL_DIR + "movielens/1/_dense_1900.model",
                "sparse_model_file": MODEL_DIR + "movielens/1/0_sparse_1900.model",
                "label": 1,
                "input_key_type": "I64",
            },
            "layers": [
