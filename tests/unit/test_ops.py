...
def test_list_slice(cpu):
    ...
    transformed = op.transform(ColumnSchemas.from_names("y"), df)
...
def test_rename(cpu):
    ...
    transformed = op.transform(ColumnSchemas.from_names("x", "y"), df)
    ...
    transformed = op.transform(ColumnSchemas.from_names("x"), df)
